...
begin
  ...
  if 1 = 10 then
    begin
      ...
      // Zmiana czasu.
      czas_blok_g :=
        '<div class="nine columns"><h2 class=''mgt0''>29 mar 2015 - Daylight Saving Time Started</h2><p>When local standard time was about to reach<br>' +
        'niedziela 29 marzec 2015, <strong>02:00:00</strong> clocks were turned <strong>forward</strong> 1 hour to <br>niedziela 29 marzec 2015, <strong>03:00:00</strong> local daylight time instead.</p>' +
        '<div class="nine columns"><h2 class=''mgt0''>25 paz 2015 - Daylight Saving Time Ended</h2><p>When local daylight time was about to reach<br>'+
        'niedziela 25 pazdziernik 2015, <strong>03:00:00</strong> clocks were turned <strong>backward</strong> 1 hour to <br>niedziela 25 pazdziernik 2015, <strong>02:00:00</strong> local standard time instead.</p>';

      // Bez zmiany czasu.
      //czas_blok_g := '<h3>Daylight Saving Time (DST) Not Observed in Year 1995</h3>';
